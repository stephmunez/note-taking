...
const ColorTheme = () => {
  return (
    <main className="z-50 flex min-h-[calc(100vh-108px)] flex-col gap-5 rounded-t-lg bg-neutral-0 px-4 pb-16 pt-5 transition-colors duration-300 dark:bg-neutral-950 md:min-h-[calc(100vh-148px)] md:gap-6 md:px-8 md:py-6">
