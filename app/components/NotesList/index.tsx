...
const NotesList = async ({ tag, isArchived }: NotesListProps) => {
  ...
  return (
    <div className="hidden max-h-[calc(100vh-102px)] min-h-[calc(100vh-102px)] max-w-[290px] flex-col gap-4 overflow-auto border-r border-solid bg-neutral-0 pb-9 pl-8 pr-5 pt-5 dark:border-r-neutral-800 dark:bg-neutral-950 lg:flex">
      <Link
