...
const MenuBar = () => {
  ...
  return (
    <footer className="fixed bottom-0 z-50 w-full border-t border-solid border-neutral-100 bg-neutral-0 px-8 py-3 transition-colors duration-300 dark:border-neutral-800 dark:bg-neutral-950 lg:hidden">
      <nav>
